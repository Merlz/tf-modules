variable "namespace" {
  default     = "global"
  description = "Namespace, which could be your organization name, e.g. 'Ex' or 'Exodus'"
}
...
variable "build_image" {
  ...
  description = "Docker image for build environment, _e.g._ `aws/codebuild/docker:17.09.0` or `aws/codebuild/eb-nodejs-6.10.0-amazonlinux-64:4.0.0`"
}
