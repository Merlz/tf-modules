...
variable "namespace" {
  type        = "string"
  description = "Namespace, which could be your organization name, e.g. 'Ex' or 'Example'"
}
...
variable "github_oauth_token" {
  type        = "string"
  default     = ""
  description = "GitHub Oauth Token for accessing private repositories. Leave it empty when deploying a public 'Jenkins' repository, e.g. https://github.com/Merlz/jenkins"
}

variable "github_organization" {
  type        = "string"
  default     = "Merlz"
  description = "GitHub organization, e.g. 'Merlz'. By default, this module will deploy 'https://github.com/Merlz/jenkins' repository"
}

variable "github_repo_name" {
  type        = "string"
  default     = "jenkins"
  description = "GitHub repository name, e.g. 'jenkins'. By default, this module will deploy 'https://github.com/Merlz/jenkins' repository"
}

variable "github_branch" {
  type        = "string"
  default     = "master"
  description = "GitHub repository branch, e.g. 'master'. By default, this module will deploy 'https://github.com/Merlz/jenkins' master branch"
}
...
variable "build_image" {
  ...
  description = "CodeBuild build image, e.g. 'aws/codebuild/docker:17.09.0'. For more info: http://docs.aws.amazon.com/codebuild/latest/userguide/build-env-ref.html#build-env-ref-available"
}
