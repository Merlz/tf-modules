...
variable "build_image" {
  ...
  description = "Docker image for build environment, e.g. 'aws/codebuild/docker:17.09.0' or 'aws/codebuild/eb-nodejs-6.10.0-amazonlinux-64:4.0.0'. For more info: http://docs.aws.amazon.com/codebuild/latest/userguide/build-env-ref.html"
}
